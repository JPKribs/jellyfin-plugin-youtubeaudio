    ...
    var SyncTableModule = {
        ...
        triggerSync: function() {
            ...
            ServerSyncShared.apiRequest('TriggerSync', 'POST').then(function() {
                ServerSyncShared.pollTaskProgress(btn, 'ServerSyncDownloadContent', 'Sync', function() {
                    self.loadSyncStatus();
                    self.loadSyncItems();
                    self.loadHealthStats();
                });
        ...
        refreshSyncTable: function() {
            ...
            ServerSyncShared.apiRequest('TriggerRefresh', 'POST').then(function() {
                ServerSyncShared.pollTaskProgress(btn, 'ServerSyncUpdateTables', 'Refresh', function() {
                    self.loadSyncStatus();
                    self.loadSyncItems();
                    self.loadHealthStats();
                });
